        ...
        >
          ...
          <Card  sx={{ height: '100%', display: 'flex', flexDirection: 'column' ,width: 350 }}>
            <CardContent sx={{ flex: 1 }}>
              ...
              <Typography variant="subtitle1">{post.recomendado}</Typography>
              ...
              {ventana === 'lugar' && (
                <>
                 <div className="form-row ml-4">
                  ...
                  >
                    <IconButton>
                      <LocationOnIcon sx={{ color: red[500] }} width={5} />{" "}
                    </IconButton>
                    Localizacion
                  </Button>
                  <Button
                  ...
                  >
                    <IconButton>
                      <VisibilityIcon sx={{ color: 'white' }} width={5} />{" "}
                    </IconButton>
                    Ver mas
                  </Button>
                  </div>
              ...
              <div className="conteiner-fluid">
                <div className="row">
                  ...
                  <Button
                    ...
                    type="default"
                    htmlType="button"
                    style={{width:200 ,color:'white',background:'coral'}}
                    onClick={() => {
                      localStorage.setItem(
                        "seleccionado",
                        JSON.stringify(post)
