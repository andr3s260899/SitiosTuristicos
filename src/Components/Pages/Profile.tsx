...
const Profile: FunctionComponent = () => {
  ...
  return (
    <div className={"profile"}>
      <img className={"backgroundIcon"} alt="" src="../background.svg" />
     
      <div className={"trips"}>
        <div className={"card4"}>
          <div className={"card4Child"} />
          <div className={"inputs"}>
            <div className={"phone"}>
              <div className={"points"}>Phone:</div>
              <div className={"phoneChild"} />
              <div className={"div"}>+57 301 321 4532</div>
            </div>
            <div className={"password"}>
              <div className={"points"}>Points:</div>
              <div className={"phoneChild"} />
              <div className={"div"}>3212</div>
            </div>
            ...
            <div className={"email"} style={{borderRadius:10}}>
              <div className={"emailAddress"}>Email Address:</div>
              <div className={"phoneChild"} />
              <div className={"estebangmailcom"}>esteban@gmail.com</div>
            </div>
            <div className={"fullname"}>
              <div className={"phoneChild"} />
              <div className={"juanEstebanCatao"}>Juan Esteban Cataño</div>
              <div className={"fullName"}>Full name:</div>
            </div>
            <img
              className={"emojiColombiaIcon"}
              alt=""
              src={`data:image/png;base64,${data}`}
            />
            <img
              className={"emojiColombiaIcon1"}
              alt=""
              src={`data:image/png;base64,${data}`}
            />
          </div>
          <img className={"circlesIcon"} alt="" src="../circles.svg" />
          <div className={"button"}>
            <div className={"buttonChild"} />
            <img
              className={"loginCircleLineIcon"}
              alt=""
              src={`data:image/png;base64,${data}`}
            />
            <div className={"createAccount"}>Update information</div>
          </div>
          <img
            className={"editBoxFillIcon"}
            alt=""
            src={`data:image/png;base64,${data}`}
          />
          <img className={"card4Item"} alt=""  src={`data:image/png;base64,${data}`} />
        </div>
        <div className={"card1"}>
          <img
            className={"card1Child"}
            alt=""
            src={`data:image/png;base64,${data}`}
          />
          <div className={"card1Item"} />
          <div className={"colombia1"}>Colombia</div>
          <div className={"guatape"}>Guatape</div>
          <img className={"iconStar"} alt=""  src={`data:image/png;base64,${data}`} />
          <div className={"div2"}>4.5</div>
          <div className={"us15000"}>US $ 150,00</div>
          <div className={"fromUs"}>From US $ 85,00</div>
          <img className={"iconHeart"} alt=""  src={`data:image/png;base64,${data}`} />
        </div>
        
      </div>
      <div className={"lastTrips"}>Last Trips</div>
    </div>
  );
};
